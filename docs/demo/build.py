...
body('02-shishen-3.html', '古人的十种状态 · 02', [
 ...
 '再换一个：你自己是「土」，木克土，那这个木就成了<span class="em">管着你</span>的那一类——'
 '压力、规矩、绕不开的人。同样一个木，到这儿又变了。',
 '同一个木，一个是靠山，一个是收成，一个是压力。'
 '<span class="em">差别不在木，在你站哪儿。</span>',
 '<span class="last">所以「我命里木多好不好」这种问法本身就是错的。'
 '得先知道你自己站在哪个位置上，这个问题才有答案——这也是为什么'
 '同一份出生数据，交给不同的人解读，出来的东西可以差那么远。</span>',
])
...
body('02-shishen-4.html', '古人的十种状态 · 03', [
 ...
 '举个能感觉到的例子：同样是「我帮的」这一类，阴阳相同的那个，'
 '力气是慢慢往外渗的，人显得温和、不着急；阴阳相异的那个，中间有股拉力，'
 '一旦开了口就收不住，话说得又快又冲。',
 '<span class="last">五类乘二，正好十个。所以「十」不是古人凑了十个词，'
 '是这个结构算下来只能是十个——不多一个，也不少一个。'
 '知道这一点之后再回头看那十个名字，就不会觉得是硬背了。</span>',
])
...
body('05-baziqa-3.html', '模型测评 · 02', [
 '先说清楚口径，不然这张图没意义：题目是 2022 到 2025 四届全球专家赛的真题，'
 '盲测——模型和人做的是同一批题，答完再对答案。'
 '蓝色那三根是历届冠亚季军的成绩，橙色是灵伴，灰色是五个通用大模型。',
...
body('09-linian-2.html', '我们怎么想的 · 01', [
 ...
 '<span class="em">「在什么条件下才成立」</span>。'
 '这句话在什么情况下是对的、什么情况下反过来、'
 '古人写它的时候默认了哪些前提没说出口。',
 '这活儿慢，也没法外包——因为要做的不是翻译，是<span class="last">替一群不在了的人补上他们省略的理由</span>。',
])
