...
body('02-shishen-3.html', '古人的十种状态 · 02', [
 '举个例子就清楚了。同样是「<span class="em">木</span>」这个东西——',
 '你自己是「火」，木生火，木就是<span class="em">托着你</span>的那一类：靠山、长辈、能借的力。<br/>'
 '你自己是「金」，金克木，木就是<span class="em">你能拿到</span>的那一类：收成、你管得住的东西。',
 '同一个木，一个是靠山，一个是收成。'
 '<span class="last">差别不在木，在你站哪儿。</span>',
])

body('02-shishen-4.html', '古人的十种状态 · 03', [
 '关系一共只有五类。因为那五种元素两两之间只可能有五种关系：'
...
body('02-shishen-6.html', '古人的十种状态 · 04', [
 ...
 '底子薄的人遇上它，就是纯压着，喘不过气。',
 '<span class="last">所以看到某个名字就说「这个好那个不好」的，基本都没入门。'
 '要看的是你扛不扛得住它。</span>',
])
...
body('09-linian-2.html', '我们怎么想的 · 01', [
 ...
 '分数确实能提，但提到某个点就卡住了。',
 '卡住的原因不在模型。是<span class="em">古人写下来的东西，大多只有结论没有理由</span>——'
 '「此人宜出外」下面没有一句为什么。',
 '结论可以背，推理背不了。所以真正的活儿是：把散在几百年里的判断，'
 '一条条还原成「在什么条件下才成立」。',
])
...
body('09-linian-4.html', '我们怎么想的 · 03', [
 '有几条我们给自己定的规矩，一直没改过：',
 '<span class="em">不做坏消息的预告。</span>我们不告诉你哪天会出事。<br/>'
 '<span class="em">不说「你注定如何」。</span>每个结论都要带上它成立的条件。<br/>'
 '<span class="em">你说不准，我们记下来。</span>反馈会让它调整对你的认知。<br/>'
 '<span class="em">你说准，我们反而警惕。</span>要查它是不是在讨好你。',
 '第四条是最容易被忽略的：一个总说你爱听的话的东西，其实什么用都没有。',
])
