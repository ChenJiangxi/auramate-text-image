...
body('07-dashang-2.html', '灵体大赏 · 01', [
 ...
 '评选没什么复杂标准，就一条：<span class="em">好看</span>。'
 '颜色配得好的、形状有意思的、亮的位置特别的，都算。'
 '我们不会按谁的粉丝多来挑，也不看你笔记写得长不长。'
 '想多写两句为什么这颗是这个样子，当然更好看，但不写也不影响入选。',
 '至于为什么办这个：灵体是这个产品里我们自己最喜欢的部分，'
 '但它长在每个人自己那儿——我们说一百句都不如你们把它放出来。',
...
body('08-jieling-5.html', '节气手记 · 04', [
 ...
 '三件事都是常识，没有一件是玄的。区别只在于：'
 '<span class="em">平时做不做无所谓，这十几天做不做，体感差很多。</span>',
 '也不用把它当成必须完成的任务。知道这几天身体在硬撑，'
 '把要求往下调一档就够了——该慢的时候慢，别硬跟自己较劲。',
...
body('09-linian-4.html', '我们怎么想的 · 03', [
 ...
 '第四条是最容易被忽略的。一个总说你爱听的话的东西，'
 '短期让人上瘾，长期什么用都没有——你从它那儿只能听到你已经相信的事。',
 '所以我们会专门去看那些「用户说很准」的样本：'
 '是真的对上了，还是它说得足够模糊，让人自己填进去了？'
 '<span class="last">后一种在这个行业里太常见了，常见到几乎成了行业标准。'
